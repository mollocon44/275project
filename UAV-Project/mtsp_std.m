function [opt_rte, min_dist, smd, dist_history, total_dist, cost] = mtsp_std(xy,dmat,salesmen,min_tour,max_tour,tw,pop_size,num_iter,use_complex,show_prog,show_res)
