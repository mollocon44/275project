...
%[opt_rte_tnt, min_dist_tnt, smd_tnt, dist_history_tnt, lt_i] =  mtsp_tnt(xy,dmat,salesmen,min_tour,max_tour,tw,pop_size,num_iter,use_complex,show_prog,show_res);
